...
const prototypePics: Pictogram[] = Array.from({ length: 6 }, (_, i) =>
...
export const boardsMock: Board[] = [
  // Emergency modules
  board(5, "module-board-quick-emergency-1", "Cardiologia", prototypePics),
  board(6, "module-board-quick-emergency-2", "Neurologia", prototypePics),
  board(7, "module-board-quick-emergency-3", "Ortopedia", prototypePics),
  board(8, "module-board-quick-emergency-4", "Geral", prototypePics),
];
